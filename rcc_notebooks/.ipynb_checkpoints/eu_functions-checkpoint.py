...
# def makexyt(ds_single, nout, ages):
...
# def gpr_predict_f(lat, lon, xyt, nout, ds_single, m, ages, df_place):
...
def run_gpr(nout, iterations, ds_single, ages, k1len, k2len, k3len, k4len, df_place):
    ...
    return ds_giapriorinterp, da_zp, ds_priorplusgpr, ds_varp, m.log_marginal_likelihood().numpy(), m
